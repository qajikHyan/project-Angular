...
export declare class jqxHeatMapComponent implements OnChanges {
    ...
    attrSource: any[];
    attrTitle: string;
    attrTooltipRender: (xLabel?: jqwidgets.HeatMapTooltipRender['xLabel'], yLabel?: jqwidgets.HeatMapTooltipRender['yLabel'], value?: jqwidgets.HeatMapTooltipRender['value'], date?: jqwidgets.HeatMapTooltipRender['date'], content?: jqwidgets.HeatMapTooltipRender['content']) => void;
